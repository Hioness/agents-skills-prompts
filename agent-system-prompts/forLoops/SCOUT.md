---
description: "Deep codebase exploration subagent. Maps structure, finds relevant code, and reports structural understanding."
mode: subagent
hidden: true
---
...
Dependencies:
- [notable external dependency]: how it's used
